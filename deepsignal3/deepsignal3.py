...
def main():
    parser = argparse.ArgumentParser(prog='deepsignal3',
                                     description="deepsignal3 detects base modifications from Nanopore "
                                                 "r10.4 reads, which contains four modules:\n"
    ...
    subparsers = parser.add_subparsers(title="modules", help='deepsignal3 modules, use -h/--help for help')
    ...
    se_extraction.add_argument("--basecall_subgroup", action="store", type=str, required=False,
    ...
    se_extraction.add_argument("--trace", action="store_true", default=False, required=False,
                            help='use trace, default false')

    se_mape = sub_extract.add_argument_group("MAPe")
    se_mape.add_argument("--corrected_group", action="store", type=str, required=False,
    ...
    se_mapping.add_argument("--coverage_ratio", type=float, default=0.75, required=False,
                            help="percent of coverage, read alignment len agaist read len, default 0.75")
    se_mapping.add_argument("--best_n", "-n", type=int, default=1, required=False,
    ...
    sc_call.add_argument('--is_trace', type=str, default="no", required=False,
    ...
    sc_f5.add_argument("--mod_loc", action="store", type=int, required=False, default=0,
                       help='0-based location of the targeted base in the motif, default 0')
    sc_f5.add_argument("--pad_only_r", action="store_true", default=False,
                       help="pad zeros to only the right of signals array of one base, "
                       "when the number of signals is less than --signal_len. "
                       "default False (pad in two sides).")
    ...
    sc_mapping.add_argument("--mapping", action="store_true", default=False, required=False,
                            help='use MAPPING to get alignment, default false')
    sc_mapping.add_argument("--mapq", type=int, default=10, required=False,
                            help="MAPping Quality cutoff for selecting alignment items, default 10")
    sc_mapping.add_argument("--identity", type=float, default=0.75, required=False,
                            help="identity cutoff for selecting alignment items, default 0.75")
    sc_mapping.add_argument("--coverage_ratio", type=float, default=0.75, required=False,
                            help="percent of coverage, read alignment len agaist read len, default 0.75")
    sc_mapping.add_argument("--best_n", "-n", type=int, default=1, required=False,
                            help="best_n arg in mappy(minimap2), default 1")
    sc_mapping.add_argument("--bwa", action="store_true", default=False, required=False,
                            help="use bwa instead of minimap2 for alignment")
    sc_mapping.add_argument("--path_to_bwa", type=str, default=None, required=False,
    ...
    st_train.add_argument('--is_signallen', type=str, default="yes", required=False,
                          help="is using signal length feature of each base in seq model, default yes")
    st_train.add_argument('--is_trace', type=str, default="no", required=False,
                          help="is using trace (base prob) feature of each base in seq model, default yes")
    # BiLSTM model param
