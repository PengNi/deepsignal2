...
from deepsignal2.utils.process_utils import complement_seq
from deepsignal2.utils.process_utils import get_refloc_of_methysite_in_motif
...
class DNAContig:
    ...
    def get_subseq_start_sites_of_comseq(self, subseq, offsetloc=0):
        return get_refloc_of_methysite_in_motif(
            self._complementseq, {subseq}, offsetloc
        )
